    ...
    <main className="min-h-screen bg-[#0a0a0f] text-[#fafafa] flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#71717a] text-sm">Start your learning journey today</p>
        </div>
        <div className="bg-[#0d0d15] border border-[#1c1c2a] rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-mono text-[#71717a] mb-2 uppercase tracking-widest">Name</label>
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} required placeholder="Your name" className="w-full bg-[#0a0a0f] border border-[#1c1c2a] rounded-xl px-4 py-3 text-sm text-[#fafafa] placeholder-[#3f3f50] focus:outline-none focus:border-[#7c3aed]/50 transition-colors" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={8} placeholder="Min 8 characters" className="w-full bg-[#0a0a0f] border border-[#1c1c2a] rounded-xl px-4 py-3 text-sm text-[#fafafa] placeholder-[#3f3f50] focus:outline-none focus:border-[#7c3aed]/50 transition-colors" />
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-[#1c1c2a] text-center">
            <p className="text-[#71717a] text-sm">Already have an account? <Link href="/login" className="text-[#a78bfa] hover:underline font-medium">Sign in</Link></p>
          </div>
        </div>
      </div>
    </main>
